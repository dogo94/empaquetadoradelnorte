    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          <label for="site_name">Site Name <a class="nounderline" data-toggle="tooltip" title="Modify this to change the name of your site, including in the <title> tag, the maintenance page and some system emails."><font color="blue">?</font></a></label>
          ...
          <!-- Copyright Option -->
          <div class="form-group">
            <label for="copyright">Copyright Message <a class="nounderline" data-toggle="tooltip" title="This message will be at the bottom of every page. The copyright symbol and year are automatically added."><font color="blue">?</font></a></label>
          ...
          <!-- Track Guests -->
          <div class="form-group">
            <label for="track_guest">Track Guests <a class="nounderline" data-toggle="tooltip" title="Want details on how many visitors are visiting your site? Keep this on! Site getting laggy, stumbling and having issues? Disable this to see if it fixes it for higher volume sites. Default: Yes."><font color="blue">?</font></a></label>
            <span style="float:right;">
              <label class="switch switch-text switch-success">
          ...
          <div class="form-group">
            <label for="navigation_type">Enable Database-Driven Navigation <a class="nounderline" data-toggle="tooltip" title="As of U 4.3 navigations can be controlled from the database, switch between the original and database-driven navigaton here. Default: Non-Database Driven."><font color="blue">?</font></a></label>
            <span style="float:right;">
              <label class="switch switch-text switch-success">
          ...
          <div class="form-group">
            <label for="custom_settings">Custom Settings Tab <a class="nounderline" data-toggle="tooltip" title="Enabling this will add a custom settings menu option on the left."><font color="blue">?</font></a></label>
            <span style="float:right;">
              <label class="switch switch-text switch-success">
          ...
          <div class="form-group">
            <label for="twofa">2 Factor Authentication <a class="nounderline" data-toggle="tooltip" title="Two Factor Auth is here! Default: Disabled.">?</a></label>
          ...
          <div class="form-group">
            <label for="admin_verify">Require Admin Re-verification <a class="nounderline" data-toggle="tooltip" title="In conjunction with ReAuth in the Pages Management section, this setting will require users to reauthenticate themselves using their password or a chosen PIN code based on the time set in the in the timeout setting. Default: Enabled."><font color="blue">?</font></a></label>
            <span style="float:right;">
              <label class="switch switch-text switch-success">
          ...
          <div class="form-group">
            <label for="admin_verify_timeout">Admin Verification Timeout <a class="nounderline" data-toggle="tooltip" title="The amount of time in Minutes that a user is prompted for Verification as described in the Admin Verification. Minimum:1, Maximum: 999999999. Default: 120 minutes."><font color="blue">?</font></a></label>
          ...
          <div class="form-group">
            ...
            <span style="float:right;">
              ...
              <div class="form-group">
                <label for="page_default_private">New Pages Default To "Private" <a class="nounderline" data-toggle="tooltip" title="Does what it says. Default: Enabled."><font color="blue">?</font></a></label>
                <span style="float:right;">
                  <label class="switch switch-text switch-success">
              ...
              <div class="form-group">
                <label for="session_manager">Enable Session Management <a class="nounderline" data-toggle="tooltip" title="Session Management will track unique details about users including their unique fingerprint, IP, OS, Browser, Session Start Time, End Time and their last activity and page. Session Management can allow forceful and soft ending of sessions including a kill switch via the Admin Panel to log all users out. Default: Enabled."><font color="blue">?</font></a></label>
                <span style="float:right;">
                  <label class="switch switch-text switch-success">
            ...
            <div class="col-sm-6">
              ...
              <!-- Messaging Option -->
              <div class="form-group">
                <label for="messaging">Enable Messaging System<a class="nounderline" data-toggle="tooltip" title="Enable or disable the built in messaging system which features Mass Messaging, user-specific messaging with replies in thread format and email notifications. Default: Disabled."><font color="blue">?</font></a></label>
                <span style="float:right;">
                  <label class="switch switch-text switch-success">
              ...
              <!-- WYSIWYG Option -->
              <div class="form-group">
                <label for="wys">Enable WYSIWYG Editor <a class="nounderline" data-toggle="tooltip" title="This does what it says. If you want to disable the Editor, you can change this. This is used in the messaging system. Default: Enabled."><font color="blue">?</font></a></label>
                <span style="float:right;">
                  <label class="switch switch-text switch-success">
              ...
              <!-- Notification System -->
              <div class="form-group">
                <label for="notifications">Enable Notification System <a class="nounderline" data-toggle="tooltip" title="Enable or disable the notification system. Default: Disabled."><font color="blue">?</font></a></label>
                <span style="float:right;">
                  <label class="switch switch-text switch-success">
              ...
              <!-- Notification System -->
              <div class="form-group">
                <label for="force_notif">Force users to see notifications <a class="nounderline" data-toggle="tooltip" title="With this enabled, notifications will popup automatically for your users. It could be annoying, but in some situatuons, notifications are crucial."><font color="blue">?</font></a></label>
                <span style="float:right;">
                  <label class="switch switch-text switch-success">
              ...
              <div class="form-group">
                <label for="redirect_uri_after_login">Redirect After Login <a class="nounderline" data-toggle="tooltip" title="The folder and file that you wish to redirect the user to after login. Default: users/account.php. Note that admins get redirected to this dashboard by default unless you intercept that call with something in usersc/scripts/custom_login_script.php"><font color="blue">?</font></a></label>
              ...
              <div class="form-group">
                <label for="min_pw">Invisible Recaptcha Public (Site) Key</label> <?php if(in_array($user->data()->id, $master_account)) {?><a href="#" class="nounderline" id="recapatcha_public_show"><span class="fa fa-eye"></span> show</a><?php } ?>
